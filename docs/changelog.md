...
All notable changes to the accsyn platform are documented here, most recent release first.
...
## v3.6-4 <small>June 10, 2026</small>
...
## v3.6-3 <small>April 19, 2026</small>
...
- [CORE/COMPUTE] New "compute_avoid" setting, defining how to act on compute process failure when it comes to avoiding nodes.
...
## v3.6-1 <small>March 29, 2026</small>
...
## v3.5-2 <small>January 4, 2026</small>
...
## v3.5-1 <small>December 15, 2025</small>
...
- [APP/CORE] Schedule disable and enable of clients, on time of day or when CPU/GPU usage reaches a certain threshold.
...
- [CORE/COMPUTE] New 'queue_interrupt_policy_compute' affecting compute jobs only.
...
## v3.4-4 <small>October 3, 2025</small>

**Minor features**

- [APP/COMPUTE] Support for engine previewable file reporting and fetch on request from browser job view.

**Changes**

- Failed compute process are not retried a second time.

**Bug fixes**

- Fixed job tasks pagination bug
- Fixed message dialog height issue
- Fixed bug when clicking file browser address element
- Fixed Windows right click selection bug

</div>

<div class="release-card" markdown>

## v3.4-3 <small>September 21, 2025</small>
...
- [WEB] Small improvements and overall bugfixes.
...
## v3.4-2 <small>September 7, 2025</small>
...
## v3.4-1 <small>August 24-28, 2025</small>
...
- [APP/VAULT] Improved drag-n-drop of local files, now available in log/ingest dialog.
...
## v3.3-3 <small>July 1, 2025</small>
...
- [APP] Restore proxy server (client "proxy_server" setting) functionality lost during v2 migration.
...
## v3.3-2 <small>June 25, 2025</small>
...
## v3.2-3 <small>May 20, 2025</small>
...
- [APP/JOB VIEW] Fixed hook exec start & end date ClassCastException.

</div>

<div class="release-card" markdown>

## v3.2-1 <small>April 13-25, 2025</small>
...
- [WEB/CORE] Fixed bug were with browser transfers were port connection failures were not handled.
- [CORE/DELIVERY] Fixed bug were deliveries from shared folders were not working.
...
## v3.1-5 <small>March 11-13, 2025</small>
...
## v3.1-4 <small>February 21-24, 2025</small>
...
- [WEB] Finished users settings page; list inactivate users, user status with ACLs, edit user - status, role and inactive status.
- [APP/BROWSER] Aligned/polished share create dialog, show generated code.
...
- [APP/INSTALLER] Fixed bug in daemon installer were ID input were hidden if ACCSYN_API_KEY env set.
- [APP] Fixed bug with transfers were changes in mapped shares for user endpoints were not updated properly.
- [APP/BROWSER] Fixed bug in access info when granting access during volume browse.
- [APP/VAULT] Fixed bug when a large delivery made cart SUBMIT button vanished.
...
## v3.1-3 <small>February 4-7, 2025</small>
...
- [APP/UPDATES] Ability turn off auto updates when prompted and in settings. Also configurable by setting environment variable ACCSYN_SKIP_UPDATE_CHECK=1.
...
- [VAULT] Titles group by options - no group, release date (default), first letter in name, year, country, genre.
- [VAULT] Titles group by options and cover sizes - small, medium(default) & large.
- [WEB/STREAMING] Option to enable download of streaming media, default off.
...
- [DELIVERY] Fixed add & remove recipients bugs.
- [WEB/STREAMING] Fixed bug where stream watch history were not shown.

**Changes**

- [CORE] Decreased background share cache updater to only scan 2 folders deep instead of 3 (workspace default 'share_cache_scan_depth' setting)
...
## v3.1-2 <small>January 26, 2025</small>
...
## v3.1-1 <small>January 24, 2025</small>
...
## v3.1-0 <small>January 19, 2025</small>
...
## v3.0-26 <small>December 19, 2024</small>

**Minor features**

- [WEB/ADMIN] Server admin pages with server installation, edit and delete.
- [APP] Cache resolved hosts and user data, in case master/accsyn.io is down.
- [CORE] Rotate process logs when they hit the 200MB mark,
- [APP/VAULT] Title covers, with additional banner, are now proper web proxies and editable.
- [APP/VAULT] Deliveries and streams are now collected in a "cart" before being submitted, to be ported to Storage view.
- [APP/VAULT] Web streams can now be mixed with standard file and folder content with the delivery.
- [APP/VAULT] Media probe on log.
- [APP/VAULT] New batch processor, initially supporting re-probe of media.
- [APP/VAULT] Refurbished media title creation and edit; now supports import of existing accsyn title, title folder template creation, banner removal and title cover reset.
- [APP/VAULT] Titles; new "End credits" attribute, on the form "hh:mm:ss".
- [APP/VAULT] Fixed bugs for employee role user when logging and managing media.
...
## v3.0-24 <small>November 24, 2024</small>
...
## v3.0-22 <small>November 18, 2024</small>
...
## v3.0-20 <small>November 15, 2024</small>
...
## v3.0-19 <small>November 8, 2024</small>
...
## v3.0-18 <small>November 5, 2024</small>
...
## v2.7-9 <small>April 7, 2024</small>
...
## v2.7-8 <small>February 4, 2024</small>
...
## v2.7-7 <small>January 7, 2024</small>
...
## v2.6-20 <small>November 9, 2023</small>
...
## v2.6-17 <small>October 16, 2023</small>
...
## v2.6-16 <small>October 16, 2023</small>
...
- [APP] Understand and follow Windows .lnk shortcut files.
- [APP] Added environment variables to strip down and remove GUI elements - ACCSYN_DISABLE_HEADER, ACCSYN_DISABLE_SUBMIT, ACCSYN_DISABLE_ATTENTION_JOBS, ACCSYN_DISABLE_ATTENTION_ACLS, ACCSYN_DISABLE_TRAY.
...
## v2.4-8 <small>May 22, 2023</small>
...
## v2.4-6 <small>April 3, 2023</small>
...
## v2.3-1_8 <small>December 21, 2022</small>
...
## v2.3-1 <small>December 9, 2022</small>
...
## v2.2-8 <small>December 4, 2022</small>
...
- (b27) Servers that serves a share is never archived anymore. BUGFIXES
...
- ACL write only access allowed on share, denying download attempts - only allowing browsing and upload. (b19) BUG fixes
...
- Videos presenting features updated @ https://www.youtube.com/channel/UCui_aQxTp-ftpwx8AJC5tzQ.
...
- Log view/audit pagination, showing default 200 entries per page, with free text search function. *b3; If files/tasks on hold, job will be kept waiting until files/tasks are re-queued. *b4; Removed client side hooks of security reasons, will be replaced with user configurable hooks in desktop app. *b4; Desktop app; Finished job reload button. List reloads every 2 minutes, reloads when job is modified. *b9; Disk log; Log entries are now stored on disk internally for better performance/lesser resource usage.

**Bug fixes**

- *b4; Progress bar not up to date with progress. *b4; Desktop app; Fixed view minimise/maximise bugs. *b4; Linux GUI theme bug fixes. *b4; Desktop app; All ACLs were not listed in file browser. *b4; Desktop app; New version, update now dialog fixed - update now always should apply. *b12; Desktop app; Fixed password reset bug.
...
- GUI; Proper interruptable progress bars on modifying jobs/queues. *b2; Python API; getsize boolean attribute to ls (file listing), calculates sizes for all directories returned in operation. *b2; File listing are more responsive, ~0.4s time cut. *b12; GUI; Prepared for future MFA (Multi Factor Authentication) implementation. *b13; Employees may now edit shares. *b13; GUI; Create queue function, delete queue.

**Bug fixes**

- *b2; Job progress updates were lagging behind in previous versions, improved internal event propagations. *b2; Desktop app file browser; Write permissions are now reflected properly when mkdir, rename, move and delete buttons are presented. *b13; GUI; Fixed bug were progerss bar did not scale properly. *b15; GUI; Mirrored uploads and downloads with user mapped root shares now works.
...
- *b1; Submit browser; Fixed bug were wrong share were displayed in address bar. *b1; Submit; Fixed bug were a user could not upload with mirrored paths from a local mapped (root) share. *b1; Submit browser; Local paths are now displayed correctly in address bar. *b2; Retry bug fix in site-site transfers, IP overrides were switched in some scenarios. *b3; Webapp; Fixed bug when browsing new root share  - could not descend into some folders.
...
- Mac OS Catalina support. *b2; Task creation date and finish date now stored in backend, showed when hovering task in desktop app. *b5; Root share space usage visualised @ admin dashboard (webapp). *b8; Client geodata collected. *b9; User geodata collected. *b10; Webapp; Account activity can be audited benath user profile page. *b11; Python API; Log session activity to disk option. *b13; App submit; Destination can now browsed during site transfers, path mirror not the only option. *b14; Mac OS Catalina support. *b14; Webapp; Files are now shown while sharing a folder with user. *b17; Submit; relative paths are now assumed being relative default root share, Accsyn no longer tries to identify first relative path element as a share (code or ID). This to decrease ambiguity and make submit definition clearer, use "share=../.." syntax do define share relative paths always from now on, or full absolute server paths.

**Bug fixes**

- *b2; Desktop app; Fixed bug in job submit - Settings view were corrupt and file browser were not aligned when leaving settings. *b3; Web app; Disabled shares can now be viewed. *b12; App submit; Fixed bugs with new share browser. *b15; Copy; Fixed bug when fast 0 bytes transfers failed even if they were successfull (process kill flushed stdout). *b16; Copy; Not overwriting an existing file with a directory (+E#J0058). *b16; GUI; Links to Accsyn warning and error codes now available in log view. *b16; ASC; Fixed bug where finished transfers could hang after they were done, now Accsyn retries indefinately to report back - prevents stuck transfers is backend is temporaily down. *b16; Fixed bug when site<>site transfers were submitted as corrupt jobs. *b16; Fixed bug when override IP:s did not apply properly for site<>site transfers. *b17; Submit; Fixed bug when submitting JSON on the form "tasks":[{..}] having tasks in a list, only one task was previously created.
...
- b28; GUI/Goto path; Option to sort by common or recent. Remembers choice. BUG FIXES (b=build)
...
## v0.9-18_17b <small>December 11, 2018</small>
...
## v0.9-18_7b <small>November 30, 2018</small>
...
## v0.9-17 <small>November 12, 2018</small>
...
## v0.9-15 <small>August 21, 2018</small>
