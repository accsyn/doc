...
This page serves as an introduction to the accsyn File Sharing subsystem - the standalone feature available on Cloud or On-prem storage, integrated into the accsyn [Media Vault](../vault/index.md).
