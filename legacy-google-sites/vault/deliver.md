...
This guide shows how to deliver media files and folders from the accsyn Media vault using the desktop app. For information about creating standard accsyn deliveries, head over to [this guide](../delivery/create.md).
...
![](../assets/vault_deliver-286bed0be050.png)
...
You can also get a brief overview of the delivery from the JOBS view in accsyn Desktop app, it is located as a tab in the bottom area.

Next, learn how to [process media](process.md) - transcode the master to various formats suitable for VOD, streaming and such.
