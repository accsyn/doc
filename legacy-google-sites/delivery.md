...
This page serves as an introduction to the accsyn File Delivery subsystem - available either as a standalone tool or built into [File Sharing](file-sharing.md) and the  [Media Vault](vault.md), or driven through [Workflows](developer.md).
