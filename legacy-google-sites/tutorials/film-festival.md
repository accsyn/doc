...
At this stage, before ingesting media, you might involve your lab provider if you need to perform additional mastering. Use [File Sharing](../file-sharing.md) within accsyn to collaborate with your lab, providing a simple yet effective file transfer workflow similar to FTP.
