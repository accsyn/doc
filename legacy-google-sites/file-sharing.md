...
We recommend watch this 1:30 minute video, providing an introduction to file sharing:

## What is accsyn File Sharing?

In princip, it is a FTP replacement combing powerful ACL mechanisms with fast, secure and resumable file transfers / deliveries.

## Why File Sharing?

With film production, and basically any type of workflows that involves files, large file sets needs to be uploaded and further distributed/delivered to remote teams.
...
Yes, accsyn provides a BYOS licensing options allowing you to install on-prem our cloud servers facilitating file sharing and delivery on your storage solutions.
